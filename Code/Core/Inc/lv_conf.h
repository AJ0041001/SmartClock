...
/* clang-format off */
#if 1 /*Enable LVGL configuration for SmartClock_F407*/
...
#define LV_MEM_CUSTOM 0
    ...
    /* The display registration already creates three LVGL screens.  The clock
       UI needs two more screens plus widgets, so 24 KiB is insufficient. */

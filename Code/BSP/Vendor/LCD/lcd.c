...
{ 	  
	...
	FSMC_NORSRAM_TimingTypeDef FSMC_WriteTim = {0};
	...
	FSMC_ReadWriteTim.CLKDivision=16;
	FSMC_ReadWriteTim.DataLatency=17;
	...
	FSMC_WriteTim.CLKDivision=16;
	FSMC_WriteTim.DataLatency=17;
	...
	/* LCD ID is reported by the caller through BSP_Log(). */
